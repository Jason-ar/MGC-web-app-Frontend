...
//CARD AUSPICIANTES
function FiestaDelCaballoCardAuspiciantes({ nombre, imageSource, direccion, rubro, ciudad }) {
  return (
...
FiestaDelCaballoCardAuspiciantes.propTypes = {
...
export { FiestaDelCaballoCardAuspiciantes };